...
describe('useSearchOptimizer', () => {
  ...
  it('should handle input changes and trigger search', async () => {
    ...
    render(<TestComponent executor={executor} onSearchSuccess={onSearchSuccess} />);
  ...
  it('should handle search errors', async () => {
    ...
    render(<TestComponent executor={executor} onSearchError={onSearchError} />);
  ...
  it('should handle cancellation', async () => {
    ...
    render(<TestComponent executor={executor} onSearchCanceled={onSearchCanceled} />);
  ...
  it('should handle direct search method call', async () => {
    ...
    const TestComponentWithSearch: React.FC = () => {
      ...
      return (
        <div>
          <input {...inputProps} data-testid="search-input" />
          <button onClick={() => search()} data-testid="search-button">
            Search
          </button>
  ...
  it('should handle aria label from options', () => {
    const executor = createMockExecutor();
    render(<TestComponent executor={executor} options={{ ariaLabel: 'Custom search' }} />);
  ...
  it('should handle search with exact minimum characters', async () => {
    ...
    render(<TestComponent executor={executor} onSearchStart={onSearchStart} />);
